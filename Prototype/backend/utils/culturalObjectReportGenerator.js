...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .object-section { margin-bottom: 50px; page-break-inside: avoid; }
        .object-header { display: flex; align-items: flex-start; margin-bottom: 20px; }
        .object-label { font-weight: bold; font-size: 14px; margin-right: 20px; margin-top: 5px; min-width: 70px; color: #000; }
        .object-image { width: 150px; height: 110px; border: 2px solid #000; display: flex; align-items: center; justify-content: center; margin-right: 25px; background: #fff; position: relative; flex-shrink: 0; }
